            ...
            for( var i = 0; i < map_properties.length; i++ ) {
                ...
                if ( map_properties[i].lat && map_properties[i].long ) {
                    ...
                    if( markerPricePins == 'yes' ) {
                        var pricePin = '<div data-id="'+map_properties[i].id+'" class="gm-marker gm-marker-color-'+map_properties[i].term_id+'"><div class="gm-marker-price">'+map_properties[i].price+'</div></div>';
