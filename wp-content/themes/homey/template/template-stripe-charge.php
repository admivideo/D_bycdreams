    ...
    case 'payment_intent.succeeded':
        ...
        if ( isset ($homey_payment_type) && $homey_payment_type == 'reservation_fee'  ) {
            ...
            if( $is_instance_booking == 0 ) { 
                ...
                $renter_message = $event->data->object->charges->data[0]->metadata->renter_message;
                ...
                if($is_hourly == 1) {
                    ...
                    $reservation_id = homey_add_hourly_instance_booking($listing_id, $check_in_date, $check_in_hour, $check_out_hour, $start_hour, $end_hour, $guests, $renter_message, $extra_options_data, $userID);
                    ...
                    $reservation_id = homey_add_instance_booking($listing_id, $check_in_date, $check_out_date, $guests, $renter_message, $extra_options_data, $userID);
                }
