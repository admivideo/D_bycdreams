<?php
global $current_user, $reservation_page_link, $wallet_page_link, $earnings_page_link, $payout_request_link, $payouts_setup_page, $security_deposits_page;
        ...
        <div class="col-sm-6 col-xs-12">
            ...
            <div class="block table-block dashboard-withdraw-table dashboard-table">
                <div class="block-title">                           
                    ...
                    <?php if(empty($guest_id) && homey_is_renter()) { ?>
                    <div class="block-right">
                        <a class="btn btn-primary btn-slim" href="<?php //echo esc_url($payouts_setup_page); ?>"><?php esc_html_e('View All', 'homey'); ?></a>
                    </div>
                    <?php } ?>
                </div>
