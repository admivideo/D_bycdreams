...
if(!function_exists('homey_get_user_subscription')) {
    function homey_get_user_subscription()
    {
      global $wpdb;
...
if(!function_exists('hm_validity_check')) {
    ...
    {
      global $wpdb;
      $memberships_url = homey_get_template_link('template/template-payment-complete.php');
      if(!homey_is_admin() && in_array('homey-membership/homey-membership.php', apply_filters('active_plugins', get_option('active_plugins')))){
        ...
        if($unlimitedListings == '' && ($remainingListings < 1 || $membershipStatus == 'expired')){
          ...
          ?>
            <script>
              document.getElementById("section-body").innerHTML = "<h3>Your listing limit is <?php echo $msgText; ?> you will redirect to plan selection page.</h3>";
...
if(!function_exists('hm_featured_limit_check')) {
    function hm_featured_limit_check()
    {
      global $wpdb;
      $memberships_url = homey_get_template_link('template/template-payment-complete.php');
      $upgrade_feature_listing_url = homey_get_template_link('template/template-payment-complete.php');
